...
namespace piksi_rtk_msgs
{
  ...
  class UartState : public ros::Msg
  {
    public:
      ...
      _header_type header;
      typedef float _uart_a_tx_throughput_type;
      _uart_a_tx_throughput_type uart_a_tx_throughput;
      typedef float _uart_a_rx_throughput_type;
      ...
      typedef float _uart_b_tx_throughput_type;
      _uart_b_tx_throughput_type uart_b_tx_throughput;
      typedef float _uart_b_rx_throughput_type;
      ...
      typedef float _uart_ftdi_tx_throughput_type;
      _uart_ftdi_tx_throughput_type uart_ftdi_tx_throughput;
      typedef float _uart_ftdi_rx_throughput_type;
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      offset += serializeAvrFloat64(outbuffer + offset, this->uart_a_tx_throughput);
      offset += serializeAvrFloat64(outbuffer + offset, this->uart_a_rx_throughput);
      ...
      *(outbuffer + offset + 0) = (this->uart_a_rx_buffer_level >> (8 * 0)) & 0xFF;
      ...
      offset += serializeAvrFloat64(outbuffer + offset, this->uart_b_tx_throughput);
      offset += serializeAvrFloat64(outbuffer + offset, this->uart_b_rx_throughput);
      ...
      *(outbuffer + offset + 0) = (this->uart_b_rx_buffer_level >> (8 * 0)) & 0xFF;
      ...
      offset += serializeAvrFloat64(outbuffer + offset, this->uart_ftdi_tx_throughput);
      offset += serializeAvrFloat64(outbuffer + offset, this->uart_ftdi_rx_throughput);
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      offset += deserializeAvrFloat64(inbuffer + offset, &(this->uart_a_tx_throughput));
      offset += deserializeAvrFloat64(inbuffer + offset, &(this->uart_a_rx_throughput));
      ...
      offset += sizeof(this->uart_a_rx_buffer_level);
      offset += deserializeAvrFloat64(inbuffer + offset, &(this->uart_b_tx_throughput));
      offset += deserializeAvrFloat64(inbuffer + offset, &(this->uart_b_rx_throughput));
      ...
      offset += sizeof(this->uart_b_rx_buffer_level);
      offset += deserializeAvrFloat64(inbuffer + offset, &(this->uart_ftdi_tx_throughput));
      offset += deserializeAvrFloat64(inbuffer + offset, &(this->uart_ftdi_rx_throughput));
