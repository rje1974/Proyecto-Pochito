#ifndef _ROS_hector_mapping_nav_HectorIterData_h
#define _ROS_hector_mapping_nav_HectorIterData_h
...
namespace hector_mapping_nav
{
  ...
  class HectorIterData : public ros::Msg
  {
    ...
    const char * getType(){ return "hector_mapping_nav/HectorIterData"; };
