#ifndef _ROS_SERVICE_ExportTrajectory_h
#define _ROS_SERVICE_ExportTrajectory_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char EXPORTTRAJECTORY[] = "ram_utils/ExportTrajectory";

  class ExportTrajectoryRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return EXPORTTRAJECTORY; };
    const char * getMD5(){ return "2415261c9605b9f38867ffbbe495fc04"; };

  };

  class ExportTrajectoryResponse : public ros::Msg
  {
    public:
  ...
  class ExportTrajectory {
    public:
    typedef ExportTrajectoryRequest Request;
    typedef ExportTrajectoryResponse Response;
  };
