#ifndef _ROS_cob_3d_mapping_msgs_TableObjectClusterFeedback_h
#define _ROS_cob_3d_mapping_msgs_TableObjectClusterFeedback_h
...
namespace cob_3d_mapping_msgs
{
  ...
  class TableObjectClusterFeedback : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "cob_3d_mapping_msgs/TableObjectClusterFeedback"; };
