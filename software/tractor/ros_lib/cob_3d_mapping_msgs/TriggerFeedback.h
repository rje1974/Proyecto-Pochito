#ifndef _ROS_cob_3d_mapping_msgs_TriggerFeedback_h
#define _ROS_cob_3d_mapping_msgs_TriggerFeedback_h
...
namespace cob_3d_mapping_msgs
{
  ...
  class TriggerFeedback : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "cob_3d_mapping_msgs/TriggerFeedback"; };
