#ifndef _ROS_SERVICE_AddToSelection_h
#define _ROS_SERVICE_AddToSelection_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char ADDTOSELECTION[] = "ram_modify_trajectory/AddToSelection";

  class AddToSelectionRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return ADDTOSELECTION; };
    const char * getMD5(){ return "f6ccb95f5843381777dba4bb5d0e3f7d"; };

  };

  class AddToSelectionResponse : public ros::Msg
  {
    public:
  ...
  class AddToSelection {
    public:
    typedef AddToSelectionRequest Request;
    typedef AddToSelectionResponse Response;
  };
