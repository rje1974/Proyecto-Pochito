#ifndef _ROS_SERVICE_AddPoses_h
#define _ROS_SERVICE_AddPoses_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char ADDPOSES[] = "ram_modify_trajectory/AddPoses";

  class AddPosesRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return ADDPOSES; };
    const char * getMD5(){ return "f6ccb95f5843381777dba4bb5d0e3f7d"; };

  };

  class AddPosesResponse : public ros::Msg
  {
    public:
  ...
  class AddPoses {
    public:
    typedef AddPosesRequest Request;
    typedef AddPosesResponse Response;
  };
