#ifndef _ROS_SERVICE_GetSelection_h
#define _ROS_SERVICE_GetSelection_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char GETSELECTION[] = "ram_modify_trajectory/GetSelection";

  class GetSelectionRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return GETSELECTION; };
    const char * getMD5(){ return "d41d8cd98f00b204e9800998ecf8427e"; };

  };

  class GetSelectionResponse : public ros::Msg
  {
    public:
  ...
  class GetSelection {
    public:
    typedef GetSelectionRequest Request;
    typedef GetSelectionResponse Response;
  };
