#ifndef _ROS_SERVICE_InvertSelection_h
#define _ROS_SERVICE_InvertSelection_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char INVERTSELECTION[] = "ram_modify_trajectory/InvertSelection";

  class InvertSelectionRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return INVERTSELECTION; };
    const char * getMD5(){ return "f6ccb95f5843381777dba4bb5d0e3f7d"; };

  };

  class InvertSelectionResponse : public ros::Msg
  {
    public:
  ...
  class InvertSelection {
    public:
    typedef InvertSelectionRequest Request;
    typedef InvertSelectionResponse Response;
  };
