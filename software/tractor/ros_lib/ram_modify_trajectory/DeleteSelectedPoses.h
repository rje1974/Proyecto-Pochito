#ifndef _ROS_SERVICE_DeleteSelectedPoses_h
#define _ROS_SERVICE_DeleteSelectedPoses_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char DELETESELECTEDPOSES[] = "ram_modify_trajectory/DeleteSelectedPoses";

  class DeleteSelectedPosesRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return DELETESELECTEDPOSES; };
    const char * getMD5(){ return "f6ccb95f5843381777dba4bb5d0e3f7d"; };

  };

  class DeleteSelectedPosesResponse : public ros::Msg
  {
    public:

    DeleteSelectedPosesResponse()
    {
    }
  ...
  class DeleteSelectedPoses {
    public:
    typedef DeleteSelectedPosesRequest Request;
    typedef DeleteSelectedPosesResponse Response;
  };
