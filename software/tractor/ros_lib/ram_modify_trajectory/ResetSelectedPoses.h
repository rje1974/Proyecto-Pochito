#ifndef _ROS_SERVICE_ResetSelectedPoses_h
#define _ROS_SERVICE_ResetSelectedPoses_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char RESETSELECTEDPOSES[] = "ram_modify_trajectory/ResetSelectedPoses";

  class ResetSelectedPosesRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return RESETSELECTEDPOSES; };
    const char * getMD5(){ return "f6ccb95f5843381777dba4bb5d0e3f7d"; };

  };

  class ResetSelectedPosesResponse : public ros::Msg
  {
    public:

    ResetSelectedPosesResponse()
    {
    }
  ...
  class ResetSelectedPoses {
    public:
    typedef ResetSelectedPosesRequest Request;
    typedef ResetSelectedPosesResponse Response;
  };
